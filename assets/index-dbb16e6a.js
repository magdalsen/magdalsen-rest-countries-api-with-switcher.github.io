(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerpolicy&&(n.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?n.credentials="include":a.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function c(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const i=document.querySelector(".container"),d=document.querySelector("#countries"),l=document.querySelector("#search"),o=document.createElement("section"),u=document.querySelector(".country-inputs"),p=document.querySelector(".dark__mode");p&&p.addEventListener("click",function(){document.body.classList.toggle("dark-mode")});const m=["germany","usa","brazil","iceland","afghan","Åland","albania","algeria"],f=t=>(o.classList.add("data__box"),o.innerHTML=`
  ...
  `,o);m.map(t=>{fetch(`https://restcountries.com/v3.1/name/${t}`).then(e=>e.json()).then(e=>{i&&(o.setAttribute("id",e[0].ccn3),i.appendChild(f(e).cloneNode(!0)),v(e))})});const g=t=>{let e=t.borders;return t.borders===void 0?"none":e.map(s=>`<button type="button" class="button__right">${s}</button>`)},b=t=>{const e=Object.entries(t.name.nativeName),s=Object.entries(t.currencies),c=Object.entries(t.languages);let a=[];return c.forEach(n=>a.push(n[1])),`
