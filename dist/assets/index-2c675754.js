(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerpolicy&&(n.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?n.credentials="include":a.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const i=document.querySelector(".container"),d=document.querySelector("#countries"),l=document.querySelector("#search"),o=document.createElement("section"),u=document.querySelector(".country-inputs"),p=document.querySelector(".dark__mode");p&&p.addEventListener("click",function(){document.body.classList.toggle("dark-mode")});const g=["germany","usa","brazil","iceland","afghan","Åland","albania","algeria"],m=t=>(o.classList.add("data__box"),o.innerHTML=`
